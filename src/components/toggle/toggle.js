  ...
  return (
    <ToggleContainer lightTheme={isLight} onClick={toggleTheme}>
      <svg
        ...
        />
        <path
          d="M426.957 256c0 86.348-64.02 157.746-147.191 169.313a170.874 170.874 0 0 1-23.762 1.64c-94.418 0-170.969-76.539-170.969-170.953 0-94.418 76.55-170.957 170.969-170.957 8.066 0 15.996.555 23.762 1.64C362.937 98.25 426.957 169.649 426.957 256zm0 0"
          fill="#f28f44"
        />
        <path
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg">
        <path
          d="M43 28c.05-.66.09-1.33.09-2a27.763 27.763 0 0 0-.44-5.03 25.552 25.552 0 0 0-2.5-7.51A22.381 22.381 0 0 0 29 3a32.934 32.934 0 0 1 24.98 13.11 27.4 27.4 0 0 1 3.75 6.91A24.754 24.754 0 0 1 59 28z"
          fill="#d9176c"
        />
        <circle cx="29" cy="6" fill="#9b1e5a" r="3" />
        <path
          d="M58 32a29 29 0 0 1-29 29A28.275 28.275 0 0 1 3 44a23.765 23.765 0 0 0 17 7 25.076 25.076 0 0 0 4.75-.46 18.565 18.565 0 0 0 1.99-.46A23.934 23.934 0 0 0 32 48l-3-6h9.98A25.326 25.326 0 0 0 44 32z"
          fill="#f9bb4b"
        />
        <path
          d="M49 45a5.006 5.006 0 0 1-5-5h2a3 3 0 0 0 6 0h2a5.006 5.006 0 0 1-5 5zM37 54.11a15.652 15.652 0 0 1-4.9.89c-5.42 0-7.14-3.93-7.35-4.46a18.565 18.565 0 0 0 1.99-.46c.46.97 2.66 4.46 9.63 2.13z"
          fill="#394d5c"
        />
        <path
          d="M57.73 23.02a3.951 3.951 0 0 1-2.43.84 3.985 3.985 0 0 1-1.32-7.75 27.4 27.4 0 0 1 3.75 6.91zM45.84 17.06a4 4 0 0 1-3.19 3.91 25.552 25.552 0 0 0-2.5-7.51 3.824 3.824 0 0 1 1.69-.4 4.005 4.005 0 0 1 4 4z"
          fill="#eb8cb3"
        />
        <g fill="#7fcac9">
          <path d="M20 42h-5a1 1 0 0 1-.707-1.707L17.586 37H15a1 1 0 0 1 0-2h5a1 1 0 0 1 .707 1.707L17.414 40H20a1 1 0 0 1 0 2zM33 32h-6a1 1 0 0 1-.707-1.707L30.586 26H27a1 1 0 0 1 0-2h6a1 1 0 0 1 .707 1.707L29.414 30H33a1 1 0 0 1 0 2zM22 22h-8a1 1 0 0 1-.707-1.707L19.586 14H14a1 1 0 0 1 0-2h8a1 1 0 0 1 .707 1.707L16.414 20H22a1 1 0 0 1 0 2z" />
        </g>
